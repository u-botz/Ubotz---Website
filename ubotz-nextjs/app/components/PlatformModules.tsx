const features = [
    ...
    },
    {
        ...
        bullets: ["Lead Scoring", "Enrollment Funnels", "Parent Engagement Portal"],
    },
    {
        icon: "payments",
        title: "Finance Hub",
...
export default function PlatformModules() {
    return (
        <section className="py-24 px-6 bg-slate-50" id="platform-modules">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map(({ icon, title, desc, bullets }) => (
                        <div
                            key={title}
                            className="glass-card p-6 rounded-2xl border border-[#319A86]/20 bg-white/50 flex flex-col"
                        >
                            <div className="size-12 bg-[#319A86]/10 rounded-xl flex items-center justify-center text-[#0C2722] mb-6">
                            ...
                            <div className="mt-auto space-y-3 pt-6 border-t border-slate-100">
                                {bullets.map((b) => (
                                    <div key={b} className="flex items-center gap-2">
                                        <span className="size-1.5 rounded-full bg-[#319A86]"></span>
